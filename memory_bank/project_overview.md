Этот документ представляет общий обзор проекта и его основных возможностей, включая профили пользователей. Расширение функциональности профиля является ключевой задачей, описанной в новом документе.
