Этот документ описывает взаимодействие с API, которое будет использоваться, в том числе, для реализации ключевой задачи по развитию личного кабинета пользователя.
